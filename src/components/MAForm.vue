...
<template>
  <div class="wrapper">
    ...
    <fieldset>
        ...
        <label for="contact">I have included all of the best ways to contact me.</label>
        </div>

        <div>
        <input type="checkbox" name="info">
        <label for="info">I have included as much information about the tattoo design/idea as I could.</label>
        </div>

        <div>
        <input type="checkbox" name="not_confirmed">
        <label for="not_confirmed">I understand that this is NOT a confirmed and booked appointment. (See above note)</label>
        </div>
      ...
      <div class="question-block">
        <p>
          <label>Tattoo Size <input type="text" name="size" /></label>
        </p>
        <p>
          <label>Tattoo Placement <input type="text" name="placement" /></label>
        </p>
        <p>
          <label
            >Color or Black & Gray? <input type="text" name="color"
          /></label>
        </p>
      </div>
      <div class="question-block">
        <p>
          <label>Tattoo Description <textarea type="text" name="subject" /></label>
        </p>
        <p>
      ...
      <div class="question-block">
        <p>
          <label>Reference 1 <input type="file" name="reference1" /></label>
        </p>
        <p>
          <label>Reference 2 <input type="file" name="reference2" /></label>
        </p>
        <p>
          <label>Reference 3 <input type="file" name="reference3" /></label>
        </p>
      </div>
...
@media only screen and (max-width: 550px) {
  .mobileWrapper {
    ...
    align-items: center;
    border-bottom: 3px solid rgba(216 112, 72, 0.5);
  }
  /* .wrapper {
